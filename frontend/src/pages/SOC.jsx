...
export default function SOC() {
  ...
  function threatLevel() {
    if (threatIndex >= 75) return { label: "CRITICAL", color: "#ff3b30" };
    if (threatIndex >= 50) return { label: "ELEVATED", color: "#ff9500" };
    if (threatIndex >= 25) return { label: "MODERATE", color: "#f5b400" };
